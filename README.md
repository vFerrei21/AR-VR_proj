...
| Página | Link |
|---|---|
| 🏠 Portal Principal | `https://SEU-USER.github.io/SEU-REPO/` |
| 🕶️ VR 360° | `https://SEU-USER.github.io/SEU-REPO/vr/` |
| ✈️ AR | `https://SEU-USER.github.io/SEU-REPO/ar/` |
...
### ⚠️ Importante
- O protocolo **HTTPS é obrigatório** — câmara e giroscópio não funcionam em HTTP
- Garante que os caminhos relativos estão corretos (`../assets/` a partir de `ar/` e `vr/`)
- Não abres os ficheiros localmente (`file://`) — usa sempre GitHub Pages
...
> Adiciona as tuas capturas após testar. Sugestão de organização:
```
screenshots/
├── landing-page.png
├── vr-sector01-core.png
├── vr-sector02-megacity.png
├── vr-sector03-wasteland.png
├── ar-overlay-gui.png
└── ar-tower-active.png
```
...
- [x] Projeto A (VR 360°) — funcional com 3 ambientes e gaze navigation
- [x] Projeto B (AR) — funcional com marcador personalizado
- [x] Marcador AR — `nexus-marker.png` + `nexus.patt`
- [x] Portal Web — `index.html` com design cyberpunk coerente
- [x] README.md — documentação completa
- [ ] Publicação GitHub Pages (fazer após upload)
- [ ] Capturas de ecrã (adicionar após testes)
